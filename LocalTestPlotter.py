...
df = crypto_candles(datetime.datetime.strftime(start_time, '%Y-%m-%d'),
                    datetime.datetime.strftime(end_time, '%Y-%m-%d'), 'BTCUSDT')
#################
# k線圖
#################
...
inc_vbar = p.vbar(source=source, view=inc, x='Date', width=w, top='Close', bottom='Open', fill_color="#25a69a",
...
# 開倉時間的點
profit_open_dot = p.triangle(source=t_source, x='open_hour_interval', y='Open', color='color', size=10, line_alpha=1,
                             fill_alpha=1, line_color='black', view=profit_view)
lose_open_dot = p.triangle(source=t_source, x='open_hour_interval', y='Open', color='color', size=10, line_alpha=0.5,
                           fill_alpha=0.5, line_color='black', view=lose_view)
# 平倉時間的點
profit_close_dot = p.circle(source=t_source, x='close_hour_interval', y='Close', color='color', size=10, line_alpha=1,
                            fill_alpha=1, line_color='black', view=profit_view)
lose_close_dot = p.circle(source=t_source, x='close_hour_interval', y='Close', color='color', size=10, line_alpha=0.5,
                          fill_alpha=0.5, line_color='black', view=lose_view)
...
output_file("Trader Candlestick.html")
